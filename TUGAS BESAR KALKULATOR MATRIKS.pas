...
procedure PenjumlahanMatriks2x2(a11, a12, a21, a22, b11, b12, b21, b22: real; 
                                  var c11, c12, c21, c22: real; row, col: integer);
begin
    if row > 2 then
        exit; // Basis rekursi: jika semua baris selesai

    // Penjumlahan elemen berdasarkan posisi baris dan kolom
    if (row = 1) and (col = 1) then
        c11 := a11 + b11
    else if (row = 1) and (col = 2) then
        c12 := a12 + b12
    else if (row = 2) and (col = 1) then
        c21 := a21 + b21
    else if (row = 2) and (col = 2) then
        c22 := a22 + b22;

    // Rekursi untuk kolom berikutnya
    if col < 2 then
        PenjumlahanMatriks2x2(a11, a12, a21, a22, b11, b12, b21, b22, c11, c12, c21, c22, row, col + 1)
    else
        PenjumlahanMatriks2x2(a11, a12, a21, a22, b11, b12, b21, b22, c11, c12, c21, c22, row + 1, 1);
end;
...
function DeterminantRecursive3x3(a11, a12, a13, a21, a22, a23, a31, a32, a33: real): real; //  jika memilih operasi determinan matriks maka function ini akan jalan untuk matriks 3x3.
...
begin
    ...
    case pilihan of
        1: if ukuran = 1 then 
           begin
               PenjumlahanMatriks2x2(a11, a12, a21, a22, b11, b12, b21, b22, c11, c12, c21, c22,row,col);
